...
function applyGermanTexts() {
  ...
  if (step2El) {
    step2El.innerHTML = "Drücke den Button zum Verbinden und wähle den korrekten COM-Port aus. <a id=\"stepDriverHelpLink\" class=\"step-inline-help-link\" href=\"#\">Wird nicht <span class=\"step-inline-help-link-tail\">angezeigt<span class=\"step-inline-help-link-q\">?</span></span></a>";
  }
...
function wireStepDriverHelpLink() {
  if (typeof document === "undefined") return;
  if (document.documentElement.dataset.stepDriverHelpWired === "1") return;
  document.documentElement.dataset.stepDriverHelpWired = "1";

  document.addEventListener("click", (event) => {
    const target = event.target;
    const linkEl =
      target && typeof target.closest === "function"
        ? target.closest("#stepDriverHelpLink")
        : null;
    if (!linkEl) return;
